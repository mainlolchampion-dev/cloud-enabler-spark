      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-8">
          <div className="flex items-center justify-between">
            <div>
              <h1 className="font-serif text-4xl font-bold text-foreground mb-2">Βαπτίσεις</h1>
              <p className="text-muted-foreground text-lg">Διαχειριστείτε τις προσκλήσεις βάπτισης σας</p>
            </div>
            <Button 
        ...
        {loading ? (
          ...
          <Card className="p-20 text-center">
            <Sparkles className="w-16 h-16 mx-auto text-muted-foreground/40 mb-6" />
            <h2 className="font-serif text-2xl font-semibold mb-3">Δεν υπάρχουν προσκλήσεις ακόμα</h2>
            <p className="text-muted-foreground mb-6">Δημιουργήστε την πρώτη σας πρόσκληση βάπτισης</p>
            <Button 
              onClick={() => navigate("/baptism/add")}
              size="lg"
              ...
              <Card key={invitation.id} className="overflow-hidden hover:shadow-xl transition-all duration-300 group">
                <div className="h-32 bg-gradient-to-br from-accent/20 to-primary/20 relative overflow-hidden">
                  <div className="absolute inset-0 flex items-center justify-center">
                    <Sparkles className="w-16 h-16 text-accent/30 group-hover:scale-110 transition-transform" />
                  </div>
                ...
                <div className="p-6 space-y-4">
                  <div>
                    ...
                    {invitation.data?.baptismDate && (
                      <div className="flex items-center gap-2 text-muted-foreground">
                        <Calendar className="w-4 h-4" />
                        <span className="text-sm">
                          {format(new Date(invitation.data.baptismDate), "d MMMM yyyy", { locale: el })}
                        </span>
                      </div>
                    )}
                  </div>
